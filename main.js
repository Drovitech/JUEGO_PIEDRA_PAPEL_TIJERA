...
function ganar(opcionUser, opcionPc){
  ...
  result_div.innerHTML= convertirLetra(opcionUser)+smallUser+" derrota a "+convertirLetra(opcionPc)+smallPc+".<br> Has ganado :D";
...
function pierda(opcionUser, opcionPc){
  ...
  const smallUser= "(USER)".fontsize(2);
  const smallPc= "(PC)".fontsize(2);
  result_div.innerHTML= convertirLetra(opcionPc)+smallPc+" derrota a "+convertirLetra(opcionUser)+smallUser+".<br> Has perdido ;(";
  const userChoice_div= document.getElementById(opcionUser);
  const pcChoice_div= document.getElementById(opcionPc);
...
function empate(opcionUser){
  result_div.innerHTML= "Los dos escogieron "+convertirLetra(opcionUser)+".<br> empate!!";
